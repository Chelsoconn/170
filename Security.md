...
2. **What is symmetric key encryption? What is it used for?**

   

3. **What is asymmetric key encryption? What is it used for?**

   Happens at TLS Handshake before messages are sent.  Encrypts keys for end to end encryption. 

4. **Describe SSL/TLS encryption process.**
...
5. **Describe the pros and cons of TLS Handshake**
